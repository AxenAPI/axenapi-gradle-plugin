...
## Подключение плагина 
1. скачайте, соберите и установите в свой локальный mvn repository (или удаленный) нужную вам версию проекта https://github.com/AxenAPI/axenapi-generator (версия должна совпадать с версией плагина).
